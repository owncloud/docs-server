...
// TODO(marketplace-screenshot): capture a current Market app browse/detail view against
// the new marketplace.owncloud.com and add it here if a fresh screenshot is warranted.
