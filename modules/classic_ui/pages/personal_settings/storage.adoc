...
To configure one or more external storages, please refer to the xref:server:admin_manual:configuration/files/external_storage/index.adoc[External Storage documentation].
