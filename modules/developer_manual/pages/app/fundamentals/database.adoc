...
* In general, don't specify a value for an `autoincrement` column.
...
Starting with ownCloud Classic 10, this is the preferred way to perform any kind of migrations and is enabled by default within core. 
...
----
{occ-command-example-prefix-docker} migrations:generate app-name {simple, SQL, schema}
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrations:execute dav 20161130090952
----
