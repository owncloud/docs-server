...
The first thing to do is to ensure that your server has the necessary software for installing and running ownCloud. While you can go further, you need to install at least the xref:admin_manual:installation/manual_installation/manual_installation.adoc[required packages]. Then, you will need to install the software required to run the development environment's installation process.
