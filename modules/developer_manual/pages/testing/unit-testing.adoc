...
Third party apps are all apps that are not distributed by {oc-marketplace-url}/publishers/owncloud[ownCloud] or not in the xref:admin_manual:installation/apps_supported.adoc[supported apps list].
====
