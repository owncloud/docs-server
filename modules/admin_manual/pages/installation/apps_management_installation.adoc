...
IMPORTANT: Any apps that are installed manually must be compatible with PHP 8; otherwise, they will most likely fail to work and make your instance unstable.
