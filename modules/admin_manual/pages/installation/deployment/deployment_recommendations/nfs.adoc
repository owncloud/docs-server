...
:page-aliases: installation/deployment_recommendations/nfs.adoc
...
* *Improved Security:* It {nfs-strong-security-architecture-url}[mandates a strong security architecture]. It does not require {rpc-statd-url}[rpc.statd]. As a result, it only uses port 2049.
