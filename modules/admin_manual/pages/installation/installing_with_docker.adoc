...
* *Pin image versions.* `OWNCLOUD_IMAGE` and `COLLABORA_IMAGE` default to a floating tag. Pin them to specific versions for reproducible, auditable upgrades (see xref:#upgrading-owncloud[Upgrading ownCloud]).
====
