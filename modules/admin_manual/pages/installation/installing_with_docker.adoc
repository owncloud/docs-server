...
These environment variables are used to the define the admin user *for system setup and first logon*. Once set, the values are fixed.
+
--
After the inital logon, you can:
