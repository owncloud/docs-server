...
* xref:server:admin_manual:installation/index.adoc[Manual Installation]
* xref:server:admin_manual:installation/docker/index.adoc[Installation with Docker]
...
* xref:server:admin_manual:maintenance/manual_upgrade.adoc[Manual Upgrade]
