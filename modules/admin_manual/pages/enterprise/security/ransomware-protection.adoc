...
NOTE: It is essential to be aware that user data needs to be synchronized with you ownCloud Classic using the
...
ownCloud Classic and allow administrators to rollback user data to a
