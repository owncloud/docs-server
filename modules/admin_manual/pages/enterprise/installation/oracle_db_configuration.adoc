...
:ubuntu_community_guide: https://help.ubuntu.com/community/Oracle%20Instant%20Client
...
{ubuntu_community_guide}[this very thorough guide] from the Ubuntu Community Wiki to install the
OCI8 extension.
