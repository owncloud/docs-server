...
The app is part of the ownCloud Docker image and only needs to be enabled:

WebUI::
Go to menu:Settings[Admin > Apps] and enable the app.

Command line::
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} app:enable windows_network_drive
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} wnd:listen MyHost MyData svc_owncloud password
----
