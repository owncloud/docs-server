...
----
{occ-command-example-prefix-docker} wnd:listen <host> <share> <username>
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} wnd:listen <host> <share> '<workgroup>\<username>'
----
...
[source,bash,subs="attributes+"]
----
cat /tmp/plainpass | {occ-command-example-prefix-docker} wnd:listen <host> <share> <username> --password-file=-
----
...
base64 -d /tmp/encodedpass | \
   {occ-command-example-prefix-docker} wnd:listen <host> <share> <username> --password-file=-
----
...
[source,bash,subs="attributes+"]
----
pass the-password-name | {occ-command-example-prefix-docker} wnd:listen <host> <share> <username> --password-file=-
----
...
[source,bash,subs="attributes+"]
----
vault kv get -field=password secret/samba | {occ-command-example-prefix-docker} wnd:listen <host> <share> <username> --password-file=-
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} wnd:listen <host> <share> <username> <password> --password-file=/opt/pass`
----
