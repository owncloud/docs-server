...
* `Kerberos Server ID` +
This ID can be chosen freely from the config paramater section `wnd.kerberos.servers` and defines required parameters for the WND Kerberos setup. Multiple ID's with different setups can be created.
* `ockeytab` +
