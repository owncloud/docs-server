...
To download your logfile via your browsers admin page, click menu:Settings[Admin > Download logfile]. The default location of the standard ownCloud log file is `mount_point/files/owncloud.log`.
