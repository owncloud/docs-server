...
image:enterprise/authentication/enterprise-only-auth/auth_backends-1.png[Authentication dropdown selector.]
...
+
image:enterprise/authentication/enterprise-only-auth/auth_backends-2.png[Global credentials form.]
