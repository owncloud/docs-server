...
The respective `Include feature` checkbox must be set to enabled.
...
** Users have a default quota of 2GB. +
Before starting the migration, go to the user profile and set the quota to unlimited.
