...
* The ownCloud-provided migration component must be installed at the ownCloud instance. They are:
...
The `occ migration:to-kiteworks:verify` step will point out missing email addresses. These must be rectified before any migration can start.
