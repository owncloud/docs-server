...
Download the latest {oc-complete-base-url}/{oc-complete-name}.tar.bz2[ownCloud Classic release] to the same location where your previous instance is located, in this example the default directory `/var/www/`.
