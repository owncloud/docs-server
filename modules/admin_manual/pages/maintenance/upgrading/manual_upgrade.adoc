...
:download-oc-url: https://owncloud.com/download-server/
...
Download the latest {download-oc-url}[ownCloud server release] to the same location where your previous instance is located, in this example the default directory `/var/www/`.
