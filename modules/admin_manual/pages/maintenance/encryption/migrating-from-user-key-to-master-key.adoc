...
----
{occ-command-example-prefix-docker} encryption:decrypt-all --continue=yes && \
  {occ-command-example-prefix-docker} encryption:disable --no-interaction && \
  {occ-command-example-prefix-docker} app:disable --no-interaction encryption
----
...
{occ-command-example-prefix-docker} app:enable encryption && \
  ...
  {occ-command-example-prefix-docker} encryption:select-encryption-type masterkey -y && \
