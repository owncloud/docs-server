...
----
{occ-command-example-prefix-docker} instance:export:user user1 /tmp/export
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} instance:import:user /tmp/export/user1
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} instance:export:migrate:share user1 https://newinstance.com
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:delete user1
----
