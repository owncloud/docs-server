...
In situations where the `<mount-point>` of your compose definition uses NFS or an external RAID systrem, the moint point may be temporarily unavailable because the resource is not available on the host. If you have experienced this, here’s how ownCloud works and what you can expect.
