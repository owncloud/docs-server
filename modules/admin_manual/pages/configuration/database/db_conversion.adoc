...
----
{occ-command-example-prefix-docker} db:convert-type [options] type username hostname database
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} db:convert-type --all-apps mysql oc_mysql_user 127.0.0.1 new_db_name
----
====
