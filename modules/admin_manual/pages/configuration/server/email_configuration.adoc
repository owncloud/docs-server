...
NOTE: You have to install and enable a custom theme in order to use and customize email templates. Additionally you need to have the Mail Template Editor app installed and enabled.
...
2.  Navigate to admin > settings > general (admin section).
3.  Select a template from the drop-down menu.
4.  Make any desired modifications to the template.

NOTE: If you don't see the drop down menu, instead you see "You need to activate own theme to edit email templates" then you haven't installed and configured a custom theme yet.
