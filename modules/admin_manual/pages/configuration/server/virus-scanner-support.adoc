...
----
{occ-command-example-prefix-docker} market:install files_antivirus
----
+
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set files_antivirus av_scan_background --value 'false'
----
