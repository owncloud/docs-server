...
----
{occ-command-example-prefix-docker}  encryption:hsmdaemon:decrypt --keyId $key_id "$test_enc"
...
{occ-command-example-prefix-docker} config:app:set encryption hsm.url --value 'http://localhost:8513'
