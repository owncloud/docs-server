...
----
{occ-command-example-prefix-docker} activity:send-emails
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set activity enable_move_and_rename_activities --value "yes"
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set activity enable_move_and_rename_activities --value "no"
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:delete activity enable_move_and_rename_activities
----
