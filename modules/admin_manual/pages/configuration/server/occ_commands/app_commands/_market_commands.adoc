...
----
{occ-command-example-prefix-docker} market:install <ids> [option]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} market:uninstall <ids>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} market:list
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} market:upgrade <ids> [options]
----
