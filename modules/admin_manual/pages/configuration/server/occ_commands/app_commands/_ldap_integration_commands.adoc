...
----
{occ-command-example-prefix-docker} ldap:search [options] [--] <search>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:search "rob"
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:search "re"
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:search "re" --offset 0 --limit 3
Rebecca OShea (Rebecca.OShea)
Rebecca Vintin (Rebecca.Vintin)
Rebekka Da-Cahuna (Rebekka.Da-Cahuna)
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:search "re" --offset 3 --limit 3
Rekha Cox (Rekha.Cox)
Rekha Craft (Rekha.Craft)
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:check-user robert
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:check-user --force robert
----
...
----
{occ-command-example-prefix-docker} ldap:create-empty-config
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:show-config [options] [--] [<configID>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:show-config
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:show-config s01
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:delete  s01
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:invalidate-cache
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:set-config <configID> <configKey> <configValue>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:set-config s01 ldapAttributesForUserSearch "cn;givenname;sn;displayname;mail"
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:test-config <configID>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ldap:test-config s01
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set user_ldap updateAttributesInterval --value=7200
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:delete user_ldap updateAttributesInterval
----
