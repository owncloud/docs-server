...
----
{occ-command-example-prefix-docker} oauth2:add-client <name> <client-id> <client-secret> <redirect-url> [<allow-sub-domains> [<trusted> [<force-trust>]]]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} oauth2:list-clients [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} oauth2:modify-client <name> <key> <value>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} oauth2:remove-client <client-id>
----
