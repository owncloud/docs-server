...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ransomguard:scan <timestamp> <user>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ransomguard:restore <timestamp> <user>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ransomguard:lock <user>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ransomguard:unlock <user>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ransomguard:blacklist:set-file <filePath>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ransomguard:blacklist:update:from-file <filePath>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} ransomguard:blacklist:update:from-site <siteUrl>
----
