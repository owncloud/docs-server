...
----
{occ-command-example-prefix-docker} twofactor_totp:delete-redundant-secret
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker}  twofactor_totp:set-secret-verification-status [options] [--] <set-verified>
----
