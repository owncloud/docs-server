...
----
{occ-command-example-prefix-docker} user:expire-password <uid> [<expiredate>]
----
...
{occ-command-example-prefix-docker} user:expire-password -u frank

# Expire the user "frank"'s password in 2 days time.
{occ-command-example-prefix-docker} user:expire-password -u frank '+2 days'

# Expire the user "frank"'s password on the 15th of August 2005, at 15:52:01 in the local timezone.
{occ-command-example-prefix-docker} user:expire-password --uid frank '2005-08-15T15:52:01+00:00'

# Expire the user "frank"'s password on the 15th of August 2005, at 15:52:01 UTC.
{occ-command-example-prefix-docker} user:expire-password --uid frank '15-Aug-05 15:52:01 UTC'
----
