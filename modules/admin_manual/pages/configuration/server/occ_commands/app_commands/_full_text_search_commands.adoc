...
----
{occ-command-example-prefix-docker} search:index:create <user_id> (<user_id>)...
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} search:index:create testuser
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} search:index:create admin testuser
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} search:index:fillSecondary [options] [--] <connector_name> <user_id>...
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} search:index:rebuild <user_id> (<user_id>)...
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} search:index:rebuild testuser
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} search:index:rebuild admin testuser
...
{occ-command-example-prefix-docker} search:index:create --all
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} search:index:update
----
