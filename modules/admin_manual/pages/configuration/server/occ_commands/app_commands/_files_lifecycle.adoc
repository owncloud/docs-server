...
The File Lifecycle Management extension allows service providers to manage the lifecycle of files within ownCloud. For details please see the xref:enterprise/file_management/files_lifecycle.adoc[File Lifecycle Management] documentation.
...
----
{occ-command-example-prefix-docker} lifecycle:archive [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} lifecycle:expire [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} lifecycle:restore <path>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} lifecycle:set-upload-time [options] [--] <date>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set files_lifecycle expire_period --value='180'
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set files_lifecycle excluded_groups --value='group1,group2'
----
