...
----
{occ-command-example-prefix-docker} instance:export:user <userId> <exportDirectory>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} instance:import:user [options] [--] <importDirectory>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} instance:export:migrate:share <userId> <remoteServer>
----
