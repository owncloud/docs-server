...
----
{occ-command-example-prefix-docker} migrate:to-ocis:init OCIS_HOST
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-ocis:verify
----
...
----
{occ-command-example-prefix-docker} migrate:to-ocis:migrate:users <ocis-admin>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-ocis:assign-role <ocis-admin>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-ocis:migrate:groups <ocis-admin>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-ocis:migrate:files <ocis-admin>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-ocis:migrate:shares <ocis-admin>
----
