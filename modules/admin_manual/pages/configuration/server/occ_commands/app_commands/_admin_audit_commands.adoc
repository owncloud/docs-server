...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:get "admin_audit ignore_cli_events"
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:delete "admin_audit ignore_cli_events"
----
