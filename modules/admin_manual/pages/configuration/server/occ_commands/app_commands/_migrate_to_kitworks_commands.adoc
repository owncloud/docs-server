...
----
{occ-command-example-prefix-docker} migrate:to-kiteworks:init KW_HOST KW_APPLICATION_ID "KW_SECRET"
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-kiteworks:verify $KW_ADMIN_USER
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-kiteworks:users $KW_ADMIN_USER $KW_PROFILE_GUEST
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-kiteworks:files $KW_ADMIN_USER
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-kiteworks:shares $KW_ADMIN_USER
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} migrate:to-kiteworks:disable-users $KW_ADMIN_USER
----
