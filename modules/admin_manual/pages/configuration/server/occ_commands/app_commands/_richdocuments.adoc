...
Collabora Online allows you to work with all kinds of collabora office documents inside ownCloud for improved productivity. For details, see the xref:enterprise/collaboration/collabora_secure_view.adoc[Collabora Online / Secure View] documentation.
...
----
{occ-command-example-prefix-docker} config:app:set richdocuments wopi_url --value='[IP/URL]:port'
----
...
----
{occ-command-example-prefix-docker} config:app:set richdocuments secure_view_option --value='true'
----
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set richdocuments watermark_text --value='Restricted to \{viewer-email}'
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set richdocuments open_in_new_tab --value='false'
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set secure_view_can_print_default --value='true'
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set richdocuments secure_view_open_action_default --value='true'
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:delete richdocuments secure_view_open_action_default
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set richdocuments secure_view_option --value='false'
----
