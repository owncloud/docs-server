...
----
{occ-command-example-prefix-docker} config:list files_antivirus
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set files_antivirus <Key> --value=<Value> --update-only
----
