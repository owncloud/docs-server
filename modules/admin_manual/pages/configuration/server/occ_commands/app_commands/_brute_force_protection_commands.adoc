...
----
{occ-command-example-prefix-docker} config:list brute_force_protection
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set brute_force_protection <Key> --value=<Value> --update-only
----
