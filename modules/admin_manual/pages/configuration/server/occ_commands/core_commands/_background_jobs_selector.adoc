...
TIP: See the xref:configuration/server/occ_command.adoc#managing-background-jobs[Managing Background Jobs] and the xref:configuration/server/background_jobs_configuration.adoc[Background Jobs configuration] to learn more.
