...
----
{occ-command-example-prefix-docker} notifications:generate [-u|--user USER] [-g|--group GROUP] [-l|--link <linktext>] [--] <subject> [<message>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} notifications:generate -g Office "Emergency Alert" "Rebooting in 5min"
----
