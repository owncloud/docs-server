...
----
{occ-command-example-prefix-docker} background:queue:delete <Job ID>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} background:queue:delete 12
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} background:queue:execute [options] [--] <Job ID>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} background:queue:execute 12
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} background:queue:status
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} background:queue:status --display-invalid-jobs
