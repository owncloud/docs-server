...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} maintenance:install [options]
----
...
Possible values: `sqlite` ,`mysql` and `pgsql`
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} maintenance:mimetype:update-db [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} maintenance:update-js
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} maintenance:mode [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} maintenance:repair [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} maintenance:update:htaccess
----
