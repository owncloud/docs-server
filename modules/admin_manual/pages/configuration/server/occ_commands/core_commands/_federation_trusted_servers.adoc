...
----
{occ-command-example-prefix-docker} federation:trusted-servers:add <url>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} federation:trusted-servers:add /
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} federation:trusted-servers:list
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} configured 
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} federation:trusted-servers:remove <id>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} federation:trusted-servers:remove 2
----
