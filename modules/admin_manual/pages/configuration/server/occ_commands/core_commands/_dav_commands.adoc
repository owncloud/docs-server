...
----
{occ-command-example-prefix-docker} dav:cleanup-chunks [options] [--] [<minimum-age-in-days>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} dav:cleanup-chunks 10
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} dav:create-addressbook <user> <name>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} dav:create-addressbook molly mollybook
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} dav:create-calendar <user> <name>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} dav:create-calendar molly mollycal
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} dav:sync-birthday-calendar [<user>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} dav:sync-birthday-calendar bernie
----
