...
----
{occ-command-example-prefix-docker} files:check-cache --help
 Usage:
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:check-cache maria welcome.txt
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:check-cache maria maria@smbhome/myfile.txt
...
In some rare cases, wrong checksums are written to the database which leads to synchronization issues, such as with the Desktop App. To mitigate such problems a new command is available: `occ files:checksums:verify`.
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:checksums:verify
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:remove-storage --help
 Usage:
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:remove-storage --show-candidates
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:scan --help
 Usage:
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files_external:list user_id
----
...
{occ-command-example-prefix-docker} files:scan --all --repair
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:scan USERID --repair
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:transfer-ownership --help
 Usage:
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:transfer-ownership \
    <source-user> \
    <destination-user>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:troubleshoot-transfer-ownership --help
 Usage:
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files:troubleshoot-transfer-ownership \
...
----
{occ-command-example-prefix-docker} files:troubleshoot-transfer-ownership all \
    --fix \
    --uid=UID
----
