...
----
{occ-command-example-prefix-docker} files_external:list [--show-password] [--full] [-a|--all] [-s|--short] [--] [<user_id>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files_external:list user_1 --short
+----------+------------------+----------+
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files_external:delete [options] [--] <mount_id>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files_external:export [options] [--] [<user_id>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files_external:import [options] [--] <path>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files_external:option <mount_id> <key> [<value>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} files_external:verify [options] [--] <mount_id>
----
