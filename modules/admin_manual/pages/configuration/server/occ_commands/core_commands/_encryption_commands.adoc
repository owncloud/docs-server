...
----
{occ-command-example-prefix-docker} app:enable encryption
{occ-command-example-prefix-docker} encryption:enable
{occ-command-example-prefix-docker} encryption:status
 - enabled: true
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} encryption:change-key-storage-root ../data/security/oc-keys
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} encryption:show-key-storage-root
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} encryption:decrypt freda
----
...
Use `encryption:disable` to disable your encryption module. You must first put your ownCloud server into xref:maintenance-commands[single-user mode] to prevent any user activity.

`encryption:migrate` migrates encryption keys after a major ownCloud version upgrade. You may optionally specify individual users in a space-delimited list. See xref:configuration/files/encryption/encryption_configuration.adoc[encryption configuration] to learn more.
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} encryption:fix-encrypted-version [options] [--] <user>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} encryption:hsmdaemon [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} encryption:hsmdaemon:decrypt [options] [--] <decrypt>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set encryption hsm.url --value 'http://127.0.0.1:8513'
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set encryption hsm.jwt.secret --value '7a7d1826-b514-4d9f-afc7-a7485084e8de'
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set encryption hsm.jwt.clockskew --value '120' 
----
