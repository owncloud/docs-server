...
----
{occ-command-example-prefix-docker} config:app:delete [options] [--] <app> <name>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:delete myappname provisioning_api
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:delete doesnotexist --error-if-not-exists
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:get [options] [--] <app> <name>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:get activity installed_version
2.2.1
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set [options] [--] <app> <name>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:import filename.json
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:import < local-backup.json
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:list [options] [--] [<app>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:list --private
----
...
{occ-command-example-prefix-docker} config:list -- system

# List system and app configuration details
# This is the default, so doesn't need to be explicitly specified
{occ-command-example-prefix-docker} config:list -- all

# List configuration details of the dav app
{occ-command-example-prefix-docker} config:list -- dav
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:delete [options] [--] <name> (<name>)...
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:delete maintenance:mode
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:get [options] [--] <name> (<name>)...
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:get version
11.0.0.0
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:set [options] [--] <name> (<name>)...
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:set maintenance \
   --value=false \
   --type=boolean
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:set apps_paths \
      --type=json \
      --value='[
        {
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:set \
   redis \
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:get trusted_domains
localhost
owncloud.local
sample.tld
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:system:set trusted_domains 2 --value=example.com
