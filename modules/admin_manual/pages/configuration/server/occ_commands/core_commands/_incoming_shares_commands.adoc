...
Instead, federated share directories are only updated when users browse them using the xref:{latest-webui-version}@webui:classic_ui:files/webgui/overview.adoc[webUI].
