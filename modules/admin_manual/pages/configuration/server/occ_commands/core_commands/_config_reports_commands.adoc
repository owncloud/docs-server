...
----
{occ-command-example-prefix-docker} configreport:generate
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} configreport:generate > generated-config-report.txt
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} configreport:generate | mail \
