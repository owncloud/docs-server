...
----
{occ-command-example-prefix-docker} log:owncloud
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} log:manage --level 4
{occ-command-example-prefix-docker} log:manage --level error
----
