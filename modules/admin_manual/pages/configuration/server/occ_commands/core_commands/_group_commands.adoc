...
----
{occ-command-example-prefix-docker} group:add Finance
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:list [options] [<search-pattern>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:list finance
 - All-Finance-Staff
 - Finance
 - Finance-Managers
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:list --output=json_pretty finance
 [
   "All-Finance-Staff",
   "Finance",
   "Finance-Managers"
...
[source,docker,subs="attributes+"]
----
-{occ-command-example-prefix-docker} group:list-members [options] <group>
----
...
----
{occ-command-example-prefix-docker} group:list-members Finance
 - aaron: Aaron Smith
 - julie: Julie Jones
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:list-members --output=json_pretty Finance
 {
   "aaron": "Aaron Smith",
   "julie": "Julie Jones"
 }
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:add-member [-m|--member [MEMBER]] <group>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:add-member --member aaron --member julie Finance
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:add-member --member aaron --member julie --member fred Finance
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:remove-member [-m|--member [MEMBER]] <group>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:remove-member --member aaron --member julie Finance
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:remove-member --member aaron --member fred Finance
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} group:delete Finance
----
