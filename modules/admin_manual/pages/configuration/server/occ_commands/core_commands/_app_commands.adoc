...
----
{occ-command-example-prefix-docker} app:list [--] [<search-pattern>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} app:enable market
market enabled
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} app:disable market
market disabled
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} app:check-code notifications
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} app:check-code foo_app
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} app:getpath notifications
