...
----
{occ-command-example-prefix-docker} versions:cleanup [<user_id>]...
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} versions:cleanup
Delete all versions
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} versions:cleanup freda molly
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} versions:expire [<user_id>]...
----
