...
----
{occ-command-example-prefix-docker} user:add \
    [--password-from-env] \
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:delete [options] [--] <uid>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:delete fred
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:disable <uid>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:enable <uid>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:home:list-dirs [options]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:home:list-dirs
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:home:list-users [options] [--] [<path>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:home:list-users /var/www/owncloud/data
  - admin
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:home:list-users --all
  - /mnt/newhome_1
    - lisa
  - /var/www/owncloud/data 
    - admin
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:inactive [options] [--] <days>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:inactive 5
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:lastseen <uid>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:lastseen layla
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:list [options] [<search-pattern>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:list ron
 - aaron: Aaron Smith
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:list --output=json_pretty
 {
   "aaron": "Aaron Smith",
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:list -a enabled
 - admin: true
 - foo: true
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:list-groups [options] [--] <uid>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:list-groups julie
 - Executive
 - Finance
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:list-groups --output=json_pretty julie
 [
   "Executive",
   "Finance"
 ]
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:modify [options] [--] <uid> <key> <value>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:modify carla email foobar@foo.com
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:move-home <user_id> <new_location>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:move-home lisa /mnt/newhome_1
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:report
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:resetpassword [options] [--] <user>
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:resetpassword layla
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:resetpassword \
  --send-email \
  --output-link \
  layla
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:setting [options] [--] <uid> [[<app> [<key>]]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:setting <uid> [<app>] [<key>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:setting layla
  - core:
    - lang: en
  - login:
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:setting layla core
 - core:
    - lang: en
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:setting layla core lang
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:setting layla core lang --value=en
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:setting layla core lang --delete
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:sync [options] [--] [<backend-class>]
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:sync "OCA\User_LDAP\User_Proxy"
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:sync "OCA\User\SMB" -vvv
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:sync "OCA\User_LDAP\User_Proxy" -m disable -r
  Analysing all users ...
      6 [============================]
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} user:sync "OCA\User_LDAP\User_Proxy" -m remove
