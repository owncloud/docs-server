...
----
{occ-command-example-prefix-docker} sharing:cleanup-remote-storages
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:set files_sharing enable_cleanup_invalid_external_shares --value no
----
...
[source,docker,subs="attributes+"]
----
{occ-command-example-prefix-docker} config:app:delete files_sharing enable_cleanup_invalid_external_shares
----
