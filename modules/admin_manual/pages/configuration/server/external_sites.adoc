...
image:external-sites-1.png[External Sites, width=350]
...
image:external-sites-4.png[image, width=350]

On this page, X-Frame-Options prevents the embedding.

image:external-sites-5.png[image, width=350]
