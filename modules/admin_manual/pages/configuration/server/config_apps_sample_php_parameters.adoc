...
This _global_ option defines the proxy URL if you are a Microsoft Business user. Note that you will get a working URL from {oc-support-url}[ownCloud Support] post a written declaration that your company has an eligable Microsoft Business contract.
