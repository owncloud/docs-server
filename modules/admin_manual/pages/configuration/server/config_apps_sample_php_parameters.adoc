...
This _global_ option defines the proxy URL if you are a Microsoft Business user. Note that you will get a working URL from {oc-support-url}[ownCloud Support] after you provide a written declaration that your company has an eligible Microsoft Business contract.
