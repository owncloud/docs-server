...
:description: ownCloud offers the ability to use full text search via the Full Text Search app connecting to a Search Elastic Server. This allows users to search not only for file names but also for content within files stored in ownCloud.
