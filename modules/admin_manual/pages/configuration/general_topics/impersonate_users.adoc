...
{description} The ability to do so is a feature delivered via an ownCloud app called *Impersonate*.
...
image::apps/impersonate/picking-a-user-to-impersonate.png[Picking a User to Impersonate, width=350]
...
+
image:apps/impersonate/impersonate_enable.png[Define who can use Impersonate,width=250]
...
+
image:apps/impersonate/impersonate_oc_admins_only.png[Impersonate for ownCloud admins only,width=350]
...
+
image:apps/impersonate/impersonate_groups_only.png[Impersonate for specific group admins,width=350]
