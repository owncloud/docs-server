...
Since ownCloud 9.0, server-side encryption for local and remote storage can operate independently. This allows to encrypt a remote storage independent of the home storage on the ownCloud server.
