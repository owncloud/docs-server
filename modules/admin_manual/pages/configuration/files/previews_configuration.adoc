...
NOTE: The dimensions here limit the size of the original image (input to the preview generator). The settings below limit the size of the generated preview images (output).
