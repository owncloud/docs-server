...
ImageMagick uses ghostscript for converting PDF. Please also make sure, that ghostscript is installed and PDF format is listed in e.g. `convert -list format`.
