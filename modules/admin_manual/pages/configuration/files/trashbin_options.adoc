...
image:configuration/files/trashbin-1.png[image, width=350]
...
----
{occ-command-example-prefix-docker} trashbin:cleanup
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} trashbin:cleanup user2 user4
...
[source,bash,subs="attributes+"]
----
{occ-command-example-prefix-docker} trashbin:cleanup user1 user2
 Remove deleted files of user1
 Remove deleted files of user2
----

See the *Deleted Files* section in xref:configuration/server/config_sample_php_parameters.adoc[Sample PHP Configuration Parameters], and the xref:configuration/server/occ_command.adoc[Trash Bin section] of the occ commands.
