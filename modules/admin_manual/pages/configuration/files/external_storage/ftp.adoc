...
image::configuration/files/external_storage/ftp_storage_support.png[The ownCloud FTP Storage Support App,width=350]
...
image::configuration/files/external_storage/ftp.png[ownCloud GUI FTP configuration,width=350]
