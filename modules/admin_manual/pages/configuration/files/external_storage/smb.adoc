...
All dependencies are provided by the ownCloud image.

== Access Testing

To ensure that you can connect to your file server with SMB, do a small test upfront like the following. Note that the `smbclient` command is not part of the ownCloud Docker image and must be provided and issued from the host.
