...
image::configuration/files/external_storage/amazons3.png[image,width=350]
...
See
xref:configuration/files/external_storage/configuration.adoc[External Storage Configuration] for additional mount options and information, and
