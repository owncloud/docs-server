...
OAuth2 functionality is available `OAuth2` app which is is shipped with the ownCloud image. For more information on how to set it up, see section xref:configuration/server/security/oauth2.adoc[Open Authentication (OAuth2)]
