...
As next step in managing groups, you can enable custom groups which provides group managing to users. For details see the xref:configuration/user/custom_groups_app.adoc[Custom Groups App].
