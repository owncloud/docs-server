...
[IMPORTANT]
====
No matter what search filter is given the app always add the value of the `User Display Name Field` (default `(displayName=*)`) to the filter so ensure that your users have this field otherwise the count will be 0.
====
