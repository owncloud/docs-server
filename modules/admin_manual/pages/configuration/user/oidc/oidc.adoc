...
(1) See the xref:configuration/user/oidc/ms-azure-setup.adoc#microsoft-azure-ad-and-redircturi[following note] when using Microsoft Azure and 127.0.0.1 as redirect URI.
